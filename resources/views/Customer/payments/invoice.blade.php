...
<div class="flex min-h-screen">
    ...
    <aside class="no-print w-72 bg-slate-950 text-white p-6 hidden lg:flex flex-col justify-between">
        <div>
    ...
    <main class="flex-1 p-6 lg:p-10">
        ...
        <div class="no-print flex flex-col lg:flex-row justify-between gap-6 items-start lg:items-center mb-8">
            <div>
                ...
                <p class="text-slate-500 mt-2">
                    View your hotel payment invoice and booking summary.
                </p>
            </div>
        ...
        @if(session('success'))
            <div class="no-print bg-green-100 text-green-700 p-4 rounded-2xl mb-6">
                {{ session('success') }}
            </div>
        @endif

        <div class="invoice-card bg-white rounded-[2rem] shadow overflow-hidden max-w-5xl mx-auto">
            ...
            <div class="p-8">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    <div class="bg-slate-50 p-6 rounded-3xl">
                        ...
                        <p class="text-slate-600">
                            {{ $payment->booking->user->phone ?? 'No phone number' }}
                        </p>
                    </div>
                    ...
                    <div class="bg-slate-50 p-6 rounded-3xl">
                        ...
                        <p class="text-slate-600">
                            Room: {{ $payment->booking->room->room_type }}
                        </p>
